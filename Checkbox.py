...
download.click()
time.sleep(1)
#click to the sub checkbox of the above boxes
desktop=driver.find_element(*(By.XPATH,"//label[@for='tree-node-desktop']//span[@class='rct-checkbox']//*[name()='svg']"))
note1=driver.find_element(*(By.XPATH,"//label[@for='tree-node-notes']//span[@class='rct-checkbox']//*[name()='svg']"))
commands=driver.find_element(*(By.XPATH,"//label[@for='tree-node-commands']//span[@class='rct-checkbox']//*[name()='svg']"))
desktop.click()
time.sleep(1)
note1.click()
time.sleep(1)
